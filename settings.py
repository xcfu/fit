...
# heat
template_versions_list_url = '/v1/{tenant_id}/template_versions'
list_stacks_url = '/v1/{tenant_id}/stacks'
show_stack_details_url = '/v1/{tenant_id}/stacks/{stack_name}/{stack_id}'
suspend_stack_url = '/v1/{tenant_id}/stacks/{stack_name}/{stack_id}/actions'
